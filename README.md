...
| Migration planning from partial context | Communities, metrics, and blast radius expose coupling before you move code |
...
**Dashboard** — visual exploration after `discover` (`.rbuilder/dashboard/`).  
