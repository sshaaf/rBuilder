...
|------|--------|----------|-----|
| [Page & Brin — PageRank (1998)](https://doi.org/10.1109/69.681760) | **Implemented** | [`centrality.rs`](../crates/rbuilder-analysis/src/centrality.rs) — `FastPageRank` | `rbuilder metrics --pagerank` |
