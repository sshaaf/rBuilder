...
pub fn register_languages(registry: &mut LanguageRegistry) {
    ...
    rbuilder_lang_swift::register(registry);
    rbuilder_lang_scala::register(registry);
    rbuilder_lang_elixir::register(registry);
    rbuilder_lang_erlang::register(registry);
    rbuilder_lang_dart::register(registry);
    rbuilder_lang_lua::register(registry);
    rbuilder_lang_haskell::register(registry);
    rbuilder_lang_julia::register(registry);
    rbuilder_lang_r::register(registry);
    rbuilder_lang_nim::register(registry);
    rbuilder_lang_ocaml::register(registry);
    rbuilder_lang_perl::register(registry);
    rbuilder_lang_fortran::register(registry);
    rbuilder_lang_verilog::register(registry);
    rbuilder_lang_vhdl::register(registry);
    rbuilder_lang_cobol::register(registry);
    rbuilder_lang_pascal::register(registry);
    rbuilder_lang_scheme::register(registry);
    rbuilder_lang_zig::register(registry);
    rbuilder_lang_fsharp::register(registry);
    rbuilder_lang_crystal::register(registry);
    rbuilder_lang_clojure::register(registry);
    rbuilder_lang_assembly::register(registry);
}
