...
use rbuilder_incremental::{FileTracker, IncrementalUpdater, UpdateOptions, UpdateResult};
...
pub fn run_update(
    ...
    if force {
        ...
        let pipeline = ProcessingPipeline::with_config(
            Arc::new(rbuilder_registry::full_registry()),
            PipelineConfig {
        ...
        let files = rbuilder_extraction::discovery::FileDiscoverer::new(Arc::new(
