...
use crate::graph::schema::{Edge, GraphParameter, Node};
...
fn parse_call_type(raw: &str) -> Option<crate::graph::schema::CallType> {
    use crate::graph::schema::CallType;
    match raw {
...
fn parse_access_type(raw: &str) -> Option<crate::graph::schema::AccessType> {
    use crate::graph::schema::AccessType;
    match raw {
...
mod tests {
    use super::*;
    use crate::graph::schema::{CallType, EdgeType, NodeType, GRAPH_SCHEMA_VERSION};
    use uuid::Uuid;
