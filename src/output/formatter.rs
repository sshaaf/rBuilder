...
use crate::analysis::dependency::ImpactResult;
use console::Style;
...
pub fn format_complexity_level(name: &str, cyclomatic: usize) -> String {
    use crate::analysis::complexity::classify_complexity;
    let level = classify_complexity(cyclomatic);
    let (emoji, label) = match level {
        crate::analysis::complexity::ComplexityLevel::Low => ("✅", "LOW"),
        crate::analysis::complexity::ComplexityLevel::Medium => ("⚠️", "MEDIUM"),
        crate::analysis::complexity::ComplexityLevel::High => ("⚠️", "HIGH"),
        crate::analysis::complexity::ComplexityLevel::Critical => ("🔴", "CRITICAL"),
    };
