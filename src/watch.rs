...
use crate::incremental::file_tracker::relative_path;
use crate::incremental::{IncrementalUpdater, UpdateOptions, UpdateResult};
...
impl WatchService {
    ...
    pub fn with_debounce(repo_root: &Path, debounce_ms: u64) -> Result<Self> {
        let registry = StdArc::new(LanguageRegistry::new());
        Ok(Self {
