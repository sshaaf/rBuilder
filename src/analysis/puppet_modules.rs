...
//!
//! ```no_run
//! use rbuilder::analysis::puppet_modules::ModuleDependencyGraph;
    ...
    pub fn analyze_modules_dir(&self, modules_path: &Path) -> Result<ModuleDependencyGraph> {
        ...
        for entry in std::fs::read_dir(modules_path)? {
            ...
            if metadata_path.exists() {
                ...
                let (symbols, relations) = parser.parse(&metadata_path.to_string_lossy(), &content);
                for sym in symbols {
                    if sym.symbol_type == crate::languages::plugin_trait::SymbolType::PuppetModule
                ...
                for rel in relations {
                    if rel.relation_type
                        == crate::languages::plugin_trait::RelationType::DependsOnModule
                    {
                        let dep = rel
                            .to
                            .strip_prefix("module::")
