...
use crate::analysis::cfg::{
    BasicBlock, BlockId, CfgEdgeType, ControlFlowGraph, Statement, StatementKind,
};
use crate::error::{Error, Result};
use crate::languages::extraction::tree_sitter::extract_name_from_node;
...
fn parse_language(language: &str, source: &[u8]) -> Result<Tree> {
    ...
    match language.to_lowercase().as_str() {
        ...
        "rust" | "rs" => return Err(Error::UnsupportedLanguage(language.to_string())),
        ...
        "python" | "py" => return Err(Error::UnsupportedLanguage(language.to_string())),
...
mod tests {
    use super::*;
    use crate::analysis::cfg::CfgEdgeType;
