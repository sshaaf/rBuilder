...
use crate::gql::ast::{Predicate, PropertyMatcher, Query};
...
impl<'a> QueryOptimizer<'a> {
    ...
    fn estimate_selectivity(&self, pattern: &crate::gql::ast::Pattern) -> f64 {
    ...
    fn estimate_property_selectivity(&self, node_pattern: &crate::gql::ast::NodePattern) -> f64 {
